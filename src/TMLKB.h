...
Node *addClassEvidenceForObj(TMLKB *kb, char *objectName, Node *node, char *className, int pol, FILE *tmlFactFile,
                             int linenum);
...
void computeRelationQueryOrAddEvidenceForObj(TMLKB *kb, Node *topNode, char *base, char *rel, char *rest, int pol,
                                             char *normalizedRelStr, char **args, int p, float logZ, int isQuery,
                                             int isClassQuery, char *outputRelStr, FILE *outFile);

void computeRelationQueryOrAddEvidence(TMLKB *kb, char *rel, char *iter, int pol, float logZ, int isQuery,
                                       FILE *outputFile);
